...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        if (80 != Calculator.calculatingDiscount(100, 20)) {
            throw new AssertionError("Ошибка в методе");
        }
        if (25 != Calculator.calculatingDiscount(50, 50)) {
            throw new AssertionError("Ошибка в методе");
        }
...
//        assertThat(Calculator.calculation(100, 50, '/')).isEqualTo(2);
        ...
        // Проверка ожидаемого исключения Discount, с использованием утверждений AssertJ:
        assertThatThrownBy(() -> Calculator.calculatingDiscount(100, -20))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Discount must be between o and 100");

        assertThatThrownBy(() -> Calculator.calculatingDiscount(100, 120))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessage("Discount must be between o and 100");

        // Тестирование метода вычисления суммы покупки со скидкой
        ...
        System.out.println(Calculator.calculation(2, 6, '+')); // integer overflow
        System.out.println(Calculator.squareRootExtraction(169));
        System.out.println(Calculator.calculatingDiscount(100, 20));
        System.out.println(Calculator.calculatingDiscount(50, 50));
